...
int main() {
    ...
    if (nombre_points < 2) {
        fprintf(stderr, "Le nombre de points doit être au moins 2.\n");
        return EXIT_FAILURE;
    }
    ...
    // Calcul de la courbe de Bézier de degré 2
    Bezier2 bezier = approx_bezier2(P, j1, j2);
...
//         P.tab[i] = bezier2_point(bezier_Q, t);
//     }

//     // Calcul de la courbe de Bézier de degré 2 pour le contour polygonal
//     Bezier2 bezier_P = approx_bezier2(P, 0, n);
