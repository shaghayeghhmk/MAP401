...
int main() {
    ...
    if (nombre_points < 2) { // Modification : Au moins 2 points pour une courbe de degré 3
        fprintf(stderr, "Le nombre de points doit être au moins 2 pour une courbe de degré 3.\n");
        return EXIT_FAILURE;
    }
